...
# - cachi2.cyclonedx.bom.json
# - syft.cyclonedx.bom.json
# - cachi2.spdx.bom.json
# - syft.spdx.bom.json
#
...
cachi2 merge-sboms --sbom-output-type "$sbom_type" "$temp_workdir/cachi2-sboms"/* |
    postprocess_cachi2_"$sbom_type" > "$testdata_dir/cachi2.$sbom_type.bom.json"

syft ./syft-sboms --select-catalogers=+sbom-cataloger -o "$syft_sbom_type" |
    postprocess_syft_"$sbom_type" > "$testdata_dir/syft.$sbom_type.bom.json"
